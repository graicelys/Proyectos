...
if (!isset($_SESSION["nombre"])) {
  ...
  header("Location: http://localhost/excel/verificacion/file.php");
  exit();
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/excel/style/css/bootstrap.min.css"> <!-- Usar css para estilo. -->
...
<div class="mx-auto" style="width: 350px;">
    <div class="p-4"></div>
    <h1 class="text-center mb-4">Subir archivo</h1>
        <div class="mb-3">
        <label for="formFile" class="form-label"></label>
        <input type="file" name="file" class="form-control">
        </div>
        <button type="submit" class="btn btn-primary mx-auto mb-3">Enviar</button>
        </div>
    </form>
